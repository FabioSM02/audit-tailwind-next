...
export function Card(){
    return(
        <div className="flex flex-col justify-center items-center border-2 border-blue-300 rounded-lg max-w-[400px] px-12 mx-4 py-4 hover:border-[#3456ee] hover:transition-colors">
            ...
            <p className="text-purple-700 font-black text-xl border-2 border-spacing-12 border-purple-900 px-4 rounded-lg hover:border-purple-700 hover:transition-all">
                $500
            </p>
        </div>
    );
