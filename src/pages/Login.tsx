...
export function Login(){
    return(
        <div className="flex items-center justify-center">
            <div className="flex flex-col items-center justify-center mt-[12vh] w-[450px] h-[500px] rounded-xl border-2 border-indigo-500 bg-indigo-100 focus:border-red-500 focus:outline-none">
                ...
                <form action="" method="get"  className="flex flex-col items-center justify-center">
                    <input type="cnpj" className="mb-4 w-64 h-9 px-2 text-violet-800 rounded-md border-[.2px] focus:border-indigo-500 focus:outline-none" name="" placeholder="CNPJ" id="" />
